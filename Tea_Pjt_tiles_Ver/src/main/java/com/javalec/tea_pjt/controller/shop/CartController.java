...
*/	}
	...
	@RequestMapping(value="list_page.do")
	public ModelAndView list(HttpSession session,ModelAndView mav,
			@RequestParam(defaultValue="") String cName,Integer csale){
		if(csale==null){
			csale=0;
		}
		
		System.out.println("~~~~~~~~~cSale 값 : " + csale);
		...
		map.put("free",free);
		map.put("sum",sumMoney+free-csale);
		map.put("list",list);
		map.put("count",list.size());
		mav.setViewName("shop/cart_list_page");
